...
- (void)layoutSubviews {
    ...
    CGFloat topTipX = CYTMainScreen_WIDTH / 2.0 - topTipW / 2.0;
    CGFloat topTipY = 30;
    ...
    if (self.title) {
        CGFloat firstW = CYTMainScreen_WIDTH - 80 * 2;
        CGFloat firstX = (CYTMainScreen_WIDTH - firstW) / 2.0;
